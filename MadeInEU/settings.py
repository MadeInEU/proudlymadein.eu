...
STATICFILES_DIRS = (
	...
	os.path.abspath(os.path.join(ROOTDIR, 'Static')),
)
...
SECRET_KEY = '9t(=^9bn&amp;!5aagf1(x0vq9^j!73-=7zvf7$$a*@sh2l)+(dd(5'
...
ROOT_URLCONF = 'MadeInEU.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'MadeInEU.wsgi.application'
...
TEMPLATE_DIRS = (
	...
	os.path.abspath(os.path.join(ROOTDIR, 'Templates')),
)
